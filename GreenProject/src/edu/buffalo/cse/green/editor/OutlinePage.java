 ...
 * @author bcmartin
 */
public class OutlinePage extends ContentOutlinePage implements ISelectionChangedListener {
...
//    	if (_viewer.getContentProvider() == null) {
    	if (_viewer.getContents() == null) {
    		// don't update
    		return;
    	}
//    	_viewer.setInput(editor);
    	_viewer.setContents(editor);
	}
...
//        _viewer = getTreeViewer();
        ...
        _viewer.setContents(_contentProvider);
