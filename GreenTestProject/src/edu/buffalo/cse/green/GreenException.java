...
public class GreenException extends RuntimeException {
	 ...
	 */
	public static final String GRWARN_ELEMENT_IN_WRONG_EDITOR = "This diagram contains an element from a project different from the one hosting the diagram.  This may be an indication that you accidentally added an element from the wrong project, but it may be exactly what you meant to do.";
