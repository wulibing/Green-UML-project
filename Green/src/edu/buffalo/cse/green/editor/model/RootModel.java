...
import edu.buffalo.cse.green.constants.ModelConstant;
...
public class RootModel extends AbstractModel<AbstractModel, AbstractModel, IJavaElement> 
	...
	public TypeModel createTypeModel(IType type) {
		...
		if (typeModel == null) {
			...
			// TODO Answer why is this needed, since 4 statements up it appears to already have been done...  
