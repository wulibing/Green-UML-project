...
implements ConnectionEditPart, PropertyChangeListener,
	...
	// TODO Carl added this constructor on 2/27/07 to see whether this resolves 
	// part of a relationship removal problem.
	public RelationshipPart() {
		...
		_sourceMultiplicityLabel.setFont(
				PlugIn.getFontPreference(P_FONT, false, false));
	}
	...
	protected final IFigure doCreateFigure() {
		...
		// TODO Should this be '1', or drawn from preferences?
	...
	private void updateFontHelper() {
		...
		// create the new font
		_sourceMultiplicityLabel.setFont(PlugIn.getFontPreference(P_FONT, false, false));
	}
