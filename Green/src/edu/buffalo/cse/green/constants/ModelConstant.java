...
/**  This is a basic constants interface designed to hold values with better
 * descriptive names attached to them.  This is specifically for the models, but 
 * may be further developed at a future time.
 * 
 * 
