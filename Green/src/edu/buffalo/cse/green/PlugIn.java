 ...
 * @author bcmartin
 *
 * TODO arc annotations don't position nicely
 * TODO need better layout (@see edu.buffalo.cse.green.editor.model.RootModel#placeUMLBox(edu.buffalo.cse.green.editor.model.TypeModel typeModel))
 */
...
//	public static final String GREEN_EXTENSION = "grn" | ";
	 ...
	 * @return The preference from the preference system for the given key.
	 */
	public static Font getFontPreference(String key, boolean bold,
			boolean italic) {
		int style = (bold ? BOLD : 0) + (italic ? ITALIC : 0);
		
		StringTokenizer tokens = new StringTokenizer("0" + getPreference(key), "|");
		tokens.nextToken();
